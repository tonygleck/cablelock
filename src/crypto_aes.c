...
int crypto_aes_encrypt(const unsigned char* cipher_text, size_t cipher_len, unsigned char* result_text, size_t result_len,
...
int crypto_aes_decrypt(const unsigned char* cipher_text, size_t cipher_len, unsigned char* result_text, size_t result_len,
